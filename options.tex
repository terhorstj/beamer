...
\usepackage{microtype,verbatim,parskip,graphicx,siunitx,nicefrac,booktabs,sansmathfonts,textpos,textgreek} 
...
\newcommand\obox[4]{\pgfsetfillopacity{0.5}\begin{textblock}{}(#1,#2)\setlength\textwidth{#3}\begin{beamercolorbox}{block body}
\vspace*{#4}\end{beamercolorbox}\end{textblock}\pgfsetfillopacity{1}}

% provides \tbox{0}{0}{text} where: x y text
\newcommand\tbox[3]{\begin{textblock}{8}(#1,#2)#3\end{textblock}}

\newcommand*\qref[4]{\textit{#1} \textbf{#2}, \textit{#3}, #4.}
